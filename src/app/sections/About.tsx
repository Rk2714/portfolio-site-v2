    ...
    <SectionWrapper id="about" className="bg-white">
      <div className="grid md:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <p className="text-[#FF6B35] font-semibold mb-6">金城 竜弥 / Kinjo Ryuya</p>
          ...
          <p className="text-[#6B7280] leading-relaxed mb-8">
            看護師として13年の臨床経験を持ち、キャリアコンサルタントとして医療従事者の支援、
            AIコンサルタントとして地域政策部でシステム導入を行うなど、多面的に活動しています。
            沖縄を拠点に「ヌチマース号」などの医療MaaS事業に参画し、地方創生とグローバル医療の両面から社会貢献を目指しています。
          </p>
