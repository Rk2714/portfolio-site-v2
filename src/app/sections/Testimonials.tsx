...
const testimonials = [
  ...
  {
    text: "出退勤・在庫管理のシステム導入で、毎日かかっていた確認作業が1/5に短縮。現場の声をしっかり聞いてくれるのが信頼できます。",
    name: "医療法人 管理部長",
    detail: "システム構築・ツール連携",
  },
  {
  ...
  {
    text: "Googleカレンダーの予約管理システムを構築していただき、予約の重複や確認漏れがゼロになりました。個人事業主にも最適な提案をしてくれます。",
    name: "個人事業主",
    detail: "Google環境セットアップ",
  },
];
